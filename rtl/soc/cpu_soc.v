...
// One physical UART is multiplexed between normal MMIO UART access
// and ROM download mode.
...
///////////////////////////////////////////////////////////////////////////////////////////////////////bus
// `addr2c` keeps the target one-hot, so the return data path can be OR-combined.
assign bus_bus_ready=ram_ready | rom_r_ready | uart_ready | led_ready | key_ready | clnt_ready;
...
cpu_jh a1 (
  ...
  .i_en(i_bus_en),
  .d_en(ram_en),
  // RAM window is rebased to start at address 0 inside `ram_c`.
